...
*Generated 2026-08-11 01:33 by `autoresearch/dashboard.py` — do not hand-edit.*

**Phase:** `quality` · **cycle:** 6 · **mode:** `incremental` · **consecutive kills:** 0
...
| 0 | `P07` | BLOCKING: the champion's microns configuration does not fit 3600 s on a loaded | proposed |
...
| 1 | `P06` | Run records discard per-stage timings (sweep.sh confirm_seeds part is fixed) | done |
...
- `results/*.json`: **355** run records across **19** variants
