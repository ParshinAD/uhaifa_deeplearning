"""Variant H79C - H79 arm: the champion stack started from ``imbalance_sort``.

Static descending sort by out_w - in_w, no peeling at all (tau 0.370638).
