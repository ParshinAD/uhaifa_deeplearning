"""Independent brute-force cross-check of the S1/S2 gain algebra.

Read-only w.r.t. the probe: imports experiments/size_collective_moves.py and
compares its exact-gain formulas against explicit full-graph rescoring by the
FROZEN oracle. Nothing here is imported by the probe.
"""
